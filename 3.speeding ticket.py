...
def speeding_ticket(speed, is_birthday):
    ...
    # Define speed limits for different ticket categories
    no_ticket_limit = 60
    small_ticket_limit = 80

    # Increase speed limits by 5 mph on the driver's birthday
    if is_birthday:
        no_ticket_limit += 5
        small_ticket_limit += 5

    # Check the driver's speed and return the appropriate ticket status
